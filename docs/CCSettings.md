...
| User memory | `~/.claude/YWCODER.md` | 个人全局偏好 | 仅自己 |
| User rules | `~/.claude/rules/*.md` | 个人模块化规则 | 仅自己 |
| Project memory | `./YWCODER.md` 或 `./.claude/YWCODER.md` | 项目指令 | 团队 (git) |
| Project rules | `./.claude/rules/*.md` | 项目模块化规则 | 团队 (git) |
| Local memory | `./YWCODER.local.md` | 本地项目偏好 | 仅自己 (gitignored) |
| Auto memory | `~/.claude/projects/<project>/memory/` | YwCoder 自动记录 | 仅自己 |
...
| **Memory & Rules** | — | — | YWCODER.md 文件族, `.claude/rules/*.md`, auto memory |
