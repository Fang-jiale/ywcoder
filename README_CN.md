...
VSCode 扩展，将 AI 编程助手直接集成到你的编辑器中。基于 Claude Code。

## 概述

YW Coder 将 AI 助手集成到 VSCode，提供具有对话历史、工具集成和智能代码理解的交互式编程助手。
...
本项目基于 [Claudix](https://github.com/Haleclipse/Claudix) by Haleclipse。
