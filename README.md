...
A VSCode extension that brings AI coding assistant directly into your editor. Based on Claude Code.

## Overview

YW Coder integrates AI assistant into VSCode, providing an interactive coding assistant with conversation history, tool integration, and intelligent code understanding.
...
1. Open the YW Coder sidebar from the activity bar
...
This project is based on [Claudix](https://github.com/Haleclipse/Claudix) by Haleclipse.
