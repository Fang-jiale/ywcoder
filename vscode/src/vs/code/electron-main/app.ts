...
/**
 * The main YwCoder application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting YwCoder');
		...
		// "com.microsoft.", which breaks native tabs for YwCoder when using this
