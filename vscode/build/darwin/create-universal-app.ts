...
async function main(buildDir?: string) {
	...
	for (const plat of ['darwin-x64', 'darwin-arm64']) {
		...
		// @github/copilot/copilot-sdk/prebuilds/{platform} (pty.node, spawn-helper)
		crossCopyPlatformDir(x64AppPath, arm64AppPath, path.join(copilotExtensionNodeModules, '@github', 'copilot', 'sdk', 'prebuilds', plat));
		// @github/copilot/copilot-sdk/ripgrep/bin/{platform} (ripgrep shim)
	...
	const filesToSkip = [
		...
		'**/node_modules/@github/copilot/copilot-sdk/prebuilds/darwin-x64/**',
		'**/node_modules/@github/copilot/copilot-sdk/prebuilds/darwin-arm64/**',
		'**/node_modules/@github/copilot/copilot-sdk/ripgrep/bin/darwin-x64/**',
		'**/node_modules/@github/copilot/copilot-sdk/ripgrep/bin/darwin-arm64/**',
	];
	...
	await makeUniversalApp({
		...
		force: true,
		mergeASARs: true,
		x64ArchFiles: '{*/kerberos.node,**/extensions/microsoft-authentication/dist/libmsalruntime.dylib,**/extensions/microsoft-authentication/dist/msal-node-runtime.node,**/node_modules/@github/copilot-darwin-*/copilot,**/node_modules/@github/copilot/prebuilds/darwin-*/*,**/node_modules.asar.unpacked/@github/copilot-darwin-*/copilot,**/node_modules.asar.unpacked/@github/copilot/prebuilds/darwin-*/*,**/extensions/copilot/node_modules/@github/copilot/copilot-sdk/prebuilds/darwin-*/*,**/extensions/copilot/node_modules/@github/copilot/copilot-sdk/ripgrep/bin/darwin-*/*}',
